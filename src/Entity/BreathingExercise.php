...
class BreathingExercise
{
    ...
    public function getInspirationDuration(): int
    {
        return $this->inspirationDuration;
    }

    public function setInspirationDuration(int $inspirationDuration): static
    {
    ...
    public function getApneaDuration(): int
    {
        return $this->apneaDuration;
    }

    public function setApneaDuration(int $apneaDuration): static
    {
    ...
    public function setExpirationDuration(int $expirationDuration): static
    {
